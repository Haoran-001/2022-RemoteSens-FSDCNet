...
class MultiviewImgDataset(torch.utils.data.Dataset):
    def __init__(self, root_dir, scale_aug=False, rot_aug=False, test_mode=False, \
        ...
        self.classnames = ['airplane', 'bathtub', 'bed', 'bench', 'bookshelf', 'bowl', 'car', 'chair',
                           'cup',  'door', 'guitar', 'keyboard', 'laptop', 'piano', 'radio', 'table',
                           'tent', 'toilet', 'vase', ]
        ...
        for i in range(len(self.classnames)):
            all_files = sorted(glob.glob(self.root_dir + '/' + self.classnames[i] + '/*.svg'))
